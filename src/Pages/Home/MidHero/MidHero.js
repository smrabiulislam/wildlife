            ...
            <div className=" px-4 sm:px-8 lg:px-16 xl:px-20">
                <div className="hero-wrapper grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                    <div className="hero-text col-span-6">
                        <h1 className=" text-left font-bold text-4xl md:text-5xl max-w-xl text-gray-900 leading-tight">Don't listen to what they say, Go See</h1>
                        <hr className=" w-12 h-1 bg-orange-500 rounded-full mt-8 " />
                        <p className="text-left text-gray-800 text-base leading-relaxed mt-8 font-semibold">Your ultimate travel companion. Carries all the information you need while travelling</p>
